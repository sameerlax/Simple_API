...
func main() {
	...
	e.GET("/service2/teams", func(c echo.Context) error {
	...
	e.GET("/service2/teams/users", func(c echo.Context) error {
		var teams []Team
	...
	e.GET("/service2/teams/:id", func(c echo.Context) error {
	...
	e.POST("/service2/teams", func(c echo.Context) error {
		team := new(Team)
	...
	e.POST("/service2/teams/:id/users", func(c echo.Context) error {
	...
	e.PUT("/service2/teams/:id", func(c echo.Context) error {
		id := c.Param("id")
		//var team Team
		team := Team{}
	...
	e.DELETE("/service2/teams/:id", func(c echo.Context) error {
		id := c.Param("id")
		var team Team
	...
	e.DELETE("/service2/teams/:Tid/users/:Uid", func(c echo.Context) error {
		var users []User
		teamId := c.Param("Tid")
		userId := c.Param("Uid")
	...
	e.GET("/service2/User", func(c echo.Context) error {
	...
	e.GET("/service2/User/:id", func(c echo.Context) error {
		id := c.Param("id")
		var user User
	...
	e.POST("/service2/User", func(c echo.Context) error {
		user := new(User)
	...
	e.PUT("/service2/User/:id", func(c echo.Context) error {
	...
	e.DELETE("/service2/User/:id", func(c echo.Context) error {
		id := c.Param("id")
		var user User
		// Convert string id to int
